...
BrowserDirect. Don't worry, even if you've never contributed to an open source
...
[ask on the discussions forum](https://github.com/nirmal-mewada/browser-direct/discussions/categories/q-a),
or even send a
[pull request](https://github.com/nirmal-mewada/browser-direct/pulls) to improve
this documentation.
...
`apps` object that contains all of the apps that BrowserDirect can find on a
...
Some browsers support opening in a _private_ or _incognito_ mode. BrowserDirect
...
Commit and push your changes to your GitHub fork of BrowserDirect, then open a
[pull request](https://github.com/nirmal-mewada/browser-direct/pulls) to merge
your branch into BrowserDirect's `main` branch. Please note that this repository
now follows the
